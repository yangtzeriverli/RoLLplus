...
routerofAS21={}
# 只有2023年的数据
f=open("/home/jiang/data/routeleak/graphdata/collectgraph/routernumber/routersofAS2021.txt")
line=f.readline()
while line:
    tmp=line.split("|")
    routerofAS21[int(tmp[0])] = eval(tmp[1])
...
while line:
    tmp=line.split("|")
    if int(tmp[0]) in routerofAS21 and int(tmp[1]) in routerofAS21 and int(tmp[2]) in routerofAS21:
        a1=routerofAS21[int(tmp[0])]
        a2=routerofAS21[int(tmp[1])]
        a3=routerofAS21[int(tmp[2])]
        if a1>=a2>=a3:
            b1=1    
        elif a1>=a3>=a2:
            b1=2
...
# 22年的平均邻居度
routerofAS22={}
f=open("/home/jiang/data/routeleak/graphdata/collectgraph/routernumber/routersofAS2022.txt")
line=f.readline()
while line:
    tmp=line.split("|")
    routerofAS22[int(tmp[0])] = eval(tmp[1])
    line=f.readline()
f.close()
...
while line:
    tmp=line.split("|")
    if int(tmp[0]) in routerofAS22 and int(tmp[1]) in routerofAS22 and int(tmp[2]) in routerofAS22:
        a1=routerofAS22[int(tmp[0])]
        a2=routerofAS22[int(tmp[1])]
        a3=routerofAS22[int(tmp[2])]
        if a1>=a2>=a3:
            b1=1    
        elif a1>=a3>=a2:
            b1=2
...
while line:
    tmp=line.split("|")
    routerofAS23[int(tmp[0])] = eval(tmp[1])
    line=f.readline()
f.close()
...
while line:
    tmp=line.split("|")
    if int(tmp[0]) in routerofAS23 and int(tmp[1]) in routerofAS23 and int(tmp[2]) in routerofAS23:
        a1=routerofAS23[int(tmp[0])]
        a2=routerofAS23[int(tmp[1])]
        a3=routerofAS23[int(tmp[2])]
        if a1>=a2>=a3:
            b1=1    
        elif a1>=a3>=a2:
            b1=2
